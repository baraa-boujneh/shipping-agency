...
public class fcpackage extends JFrame {
	...
	public fcpackage() {
		...
		JLabel lblNewJgoodiesTitle = DefaultComponentFactory.getInstance().createTitle(" commercial package");
		...
		try {
			...
			Courier l=new Commercial_package(textField,bgs,textField_1,textField_2);
			dispose();
